function ret_val = differentialEvolution2(options,v,p)
...
%     end
    ...
    for i = 1: no_vector
    fitness(i) = wta_loss(population(i,:),v,p);
    end
