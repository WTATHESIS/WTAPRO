...
for rhoind = 1 : 10
    ...
    filename = ['victory',int2str(rhoind*10),'.mat'];
    valuename = ['victory'];
    save(filename,valuename);
    
    filename = ['stage',int2str(rhoind*10),'.mat'];
    valuename = ['stage'];
    save(filename,valuename);
    
    filename = ['nav',int2str(rhoind*10),'.mat'];
    valuename = ['nav'];
    save(filename,valuename);
    
    filename = ['time',int2str(rhoind*10),'.mat'];
    valuename = ['time'];
    save(filename,valuename);
    
    filename = ['fit',int2str(rhoind*10),'.mat'];
    valuename = ['fit'];
    save(filename,valuename);
    
    filename = ['weares',int2str(rhoind*10),'.mat'];
    valuename = ['weares'];
    save(filename,valuename);
    
    filename = ['tarres',int2str(rhoind*10),'.mat'];
    valuename = ['tarres'];
    save(filename,valuename);   
