...
for i = 1 : PopSize
    ...
    [ Population(i).Constraint ] = ConstraintViolation( WeaponNum , Population(i).Position , KillRange , SafeNum , SafePosition , TargetNum , TargetPosition , TargetSurvive , SurviveThreshold , EnforceMatrix );
      
    %Population(i).Fitness(1) = Population(i).Fitness(1) + Population(i).Constraint;
