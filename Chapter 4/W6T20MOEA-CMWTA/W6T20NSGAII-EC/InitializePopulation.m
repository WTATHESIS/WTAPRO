...
while (WeaponIndex <= PopSize)
    ...
    if FeasibleFlag == true
        ...
        [ Population(WeaponIndex).Constraint ] = ConstraintViolation( WeaponNum , Population(WeaponIndex).Position , KillRange , SafeNum , SafePosition , TargetNum , TargetPosition , TargetSurvive , SurviveThreshold , EnforceMatrix );
