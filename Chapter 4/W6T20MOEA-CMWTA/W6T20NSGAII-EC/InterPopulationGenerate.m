...
while 1
    ...
    if rand < 0.8
        ...
        if FeasibleFlag == true
            ...
            [ InterPopulation(InterPopSize).Constraint ] = ConstraintViolation( WeaponNum , Child1 , KillRange , SafeNum , SafePosition , TargetNum , TargetPosition , Child1TargetSurvive , SurviveThreshold , EnforceMatrix );;
        ...
        if FeasibleFlag == true
            ...
            [ InterPopulation(InterPopSize).Constraint ] = ConstraintViolation( WeaponNum , Child2 , KillRange , SafeNum , SafePosition , TargetNum , TargetPosition , Child2TargetSurvive , SurviveThreshold , EnforceMatrix );
        ...
        if FeasibleFlag == true
            ...
            [ InterPopulation(InterPopSize).Constraint ] = ConstraintViolation( WeaponNum , Child3 , KillRange , SafeNum , SafePosition , TargetNum , TargetPosition , Child3TargetSurvive , SurviveThreshold , EnforceMatrix );;
