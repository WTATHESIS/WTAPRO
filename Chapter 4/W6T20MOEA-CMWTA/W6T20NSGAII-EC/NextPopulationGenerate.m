function [ NextPopulation ] = NextPopulationGenerate( InterPopSize , InterPopulation , PopSize , WeaponNum , epsilon , GenCount )
...
[ InterPopulation ] = DominateSort( InterPopulation , InterPopSize , epsilon , GenCount );
