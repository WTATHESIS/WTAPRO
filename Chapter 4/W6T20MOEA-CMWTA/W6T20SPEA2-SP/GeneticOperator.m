...
while OffSpringSize < PopSize
    ...
    if rand < 0.8
        ...
        [ Child1 , FeasibleFlag ] = WeaponPositionFeasible( Child1 , WeaponNum , TargetPosition , TargetNum , KillRange , SurviveThreshold , EnforceMatrix );
        ...
        [ Child2 , FeasibleFlag ] = WeaponPositionFeasible( Child2 , WeaponNum , TargetPosition , TargetNum , KillRange , SurviveThreshold , EnforceMatrix );
        if FeasibleFlag == true
        ...
        [ Child3 , FeasibleFlag ] = WeaponPositionFeasible( Child3 , WeaponNum , TargetPosition , TargetNum , KillRange , SurviveThreshold , EnforceMatrix );
        if FeasibleFlag == true
